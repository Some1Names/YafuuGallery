...
export default function AdminImageUploadButton({
  ...
  return (
    <div>
      <label className="block text-[10px] uppercase tracking-widest text-[#6b655e] font-mono mb-1.5">
        {label}
      </label>
      ...
      >
        {value ? (
          ...
          <span className="w-full h-full flex items-center justify-center text-xs text-[#6b655e] font-mono">
            No image
          </span>
        )}
