...
export default function ArcRow({ arc, onSelect }: ArcRowProps) {
  return (
    <button
      ...
      className="h-18 sm:h-30 group flex items-center gap-3 sm:gap-8 cursor-pointer text-left bg-[#1b1a1c]/95 hover:bg-[#232224] border border-[#050505] hover:border-[#f6f1f2] transition-colors duration-200"
    >
