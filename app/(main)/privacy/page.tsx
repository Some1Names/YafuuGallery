...
export const metadata: Metadata = {
  ...
  description: "What YafuuGallery collects, why, who helps us run the site, and your rights.",
};
  ...
  return (
    ...
    >
      ...
      <LegalSection title="Cookies and browser storage">
        <p>
          We use one cookie, to keep you signed in. Your browser also saves a few settings on your own device — light or
